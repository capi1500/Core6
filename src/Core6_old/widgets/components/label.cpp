...
namespace c6{
	namespace widget{
		namespace component{
			...
			void Label::applyFrameDef(WidgetAssetPack::FrameDef& def){
			...
			Label::Label(WidgetAssetPack::FrameDef& frameDef, const WidgetAssetPack::TextDef& textDef){
				applyFrameDef(frameDef);
				applyTextDef(textDef);
				currentFrame = &regular;
			}
			
			Label::Label(WidgetAssetPack::FrameDef& frameDef, const WidgetAssetPack::TextDef& textDef, const sf::Vector2u& size){
				applyFrameDef(frameDef);
				applyTextDef(textDef);
				setSize(size);
				currentFrame = &regular;
			...
			Label::Label(WidgetAssetPack::FrameDef& frameDef, const WidgetAssetPack::TextDef& textDef, const std::string& string){
				applyFrameDef(frameDef);
				applyTextDef(textDef);
			...
			Label::Label(WidgetAssetPack::FrameDef& frameDef, const WidgetAssetPack::TextDef& textDef, const sf::Vector2u& size, const std::string& string){
				applyFrameDef(frameDef);
				applyTextDef(textDef);
				setSize(size);
				text.setString(string);
