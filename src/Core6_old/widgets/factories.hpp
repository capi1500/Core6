...
namespace c6{
	namespace widget{
		namespace factory{
			...
			auto labelFactory = WidgetFactory<Config, const sf::Vector2u&, const std::string&>([](Agent<Config>& agent, WidgetAssetPack& assetPack, const sf::Vector2f& position, const sf::Vector2u& size, const std::string& string){
