...
c6::Scene<Config>* Game::scene1(){
	...
	assetPack.frame.regular.part[0][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[0][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[0][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[0][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[0][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[0][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[0][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[0][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[0][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[1][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[1][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[1][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[1][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[1][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[1][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[1][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[1][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[1][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[2][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[2][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[2][0].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[2][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[2][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[2][1].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.regular.part[2][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.highlighted.part[2][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	assetPack.frame.disabled.part[2][2].setTexture(Framework::getResourceManager().getTexture("../assets/textures/rgb/blue.png"));
	
	scene->newAgent<c6::WidgetAssetPack&, const sf::Vector2f&, const sf::Vector2u&, const std::string&>
