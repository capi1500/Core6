...
struct MoveOnCopy {
   ...
   static constexpr bool is_nothrow_move_constructible{std::is_nothrow_move_constructible_v<Moveable>};
   static constexpr bool is_nothrow_move_assignable{std::is_nothrow_move_assignable_v<Moveable>};
